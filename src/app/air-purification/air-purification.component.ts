...
@Component({
  selector: 'app-air-purification',
  templateUrl: './air-purification.component.html',
  styleUrls: ['./air-purification.component.css'],
})
export class AirPurificationComponent implements OnInit {
  constructor() {}
